...
// ====================================================================================
function FoxClocks_openFoxClocksWindow() { FoxClocks_openWindow("chrome://mole/content/foxclocks.xul", "", "chrome,centerscreen,resizable=yes"); }
function FoxClocks_openAboutWindow() { FoxClocks_openWindow("chrome://mole/content/about.xul", "", "chrome,modal,centerscreen,resizable=no"); }
